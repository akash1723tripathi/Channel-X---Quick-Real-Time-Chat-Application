...
const ProfilePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Create a FormData object for sending text + file
    const formData = new FormData();
    formData.append("fullName", name);
    formData.append("bio", bio);
    if (selectedImg) {
      formData.append("profilePic", selectedImg); // file itself
    }

    await updateProfile(formData);  // pass FormData to API call
    navigate("/");
  };
